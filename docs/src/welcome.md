...
## ⚠️ This documentation was written for PySLSQP_alpha which is now moved to [PySLSQP](https://github.com/anugrahjo/PySLSQP/). PySLSQP_alpha is now archived and read-only and this documentation is obsolete. Please visit [PySLSQP docs](https://pyslsqp.readthedocs.io/) for the latest documentation.⚠️
